...
namespace DatabaseProject.MyCompanyDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [firstName] = @firstName, [lastName] = @lastName WHERE (([customerID] = @Original_customerID) AND ([firstName] = @Original_firstName) AND ([lastName] = @Original_lastName));
SELECT customerID, firstName, lastName FROM Customer WHERE (customerID = @customerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseProject.Properties.Settings.Default.MyCompanyConnectionString;
        }
        ...
        public virtual int Fill(MyCompanyDataSet.CustomerDataTable dataTable) {
        ...
        public virtual MyCompanyDataSet.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyCompanyDataSet.CustomerDataTable dataTable = new MyCompanyDataSet.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyCompanyDataSet.CustomerDataTable dataTable) {
